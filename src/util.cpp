...
const char * const BITCOIN_CONF_FILENAME = "a12coin.conf";
const char * const BITCOIN_PID_FILENAME = "a12coind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "A12coin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/A12coin";
#else
    // Unix
    return pathRet / ".a12coin";
#endif
#endif
}
