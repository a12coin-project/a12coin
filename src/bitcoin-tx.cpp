...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s a12coin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  a12coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded a12coin transaction") + "\n" +
              "  a12coin-tx [options] -create [commands]   " + _("Create hex-encoded a12coin transaction") + "\n" +
              "\n";
