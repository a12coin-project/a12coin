...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/a12coin.ico %{buildroot}%{_datadir}/pixmaps/a12coin.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/bitcoin.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/a12coin16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/a12coin32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/a12coin64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/a12coin128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/a12coin256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/a12coin256.png %{buildroot}%{_datadir}/pixmaps/a12coin16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/a12coin256.png %{buildroot}%{_datadir}/pixmaps/a12coin32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/a12coin256.png %{buildroot}%{_datadir}/pixmaps/a12coin64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/a12coin256.png %{buildroot}%{_datadir}/pixmaps/a12coin128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/a12coin256.png %{buildroot}%{_datadir}/pixmaps/a12coin256.xpm
...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7333
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 27332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 27335
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 27443
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 27444
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 7332
	%{_sbindir}/semanage port -d -p tcp 7333
	%{_sbindir}/semanage port -d -p tcp 27332
	%{_sbindir}/semanage port -d -p tcp 27335
	%{_sbindir}/semanage port -d -p tcp 27443
	%{_sbindir}/semanage port -d -p tcp 27444
	for selinuxvariant in %{selinux_variants}; do
